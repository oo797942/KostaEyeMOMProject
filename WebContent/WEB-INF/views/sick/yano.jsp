...
<td width="200px;" valign="top">
 				<div>
  				...
  				<div class="elements1">
 					...
 					<a class="side" href="yano.do" style="background-color: #ffa07a; color:#fff; padding-right: 85px;" > － 야뇨증</a><br/> 					
...
<div class="pee_top">
	<div class="pt80 pl64"><img style="padding-left:60px" src="/EyeMOM/resources/img/sick/pee_top_txt01.gif"></div><br/>
	<div class="pee_tip"><img style="padding-left:40px" src="/EyeMOM/resources/img/sick/pee_tip.gif"></div><br/>
	<div style="text-align:center"><img src="/EyeMOM/resources/img/sick/pee_check.gif"></div><br/>
</div>


	<img src="/EyeMOM/resources/img/sick/pee01_tit.jpg"><br/><br/>

<dl class="contB">
	<dt><img src="/EyeMOM/resources/img/sick/pee02_tit.gif"></dt>
	<dd><img src="/EyeMOM/resources/img/sick/pee02_txt.gif"></dd>
</dl><br/>
