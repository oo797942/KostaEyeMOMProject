...
<!--         메인 -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">공부해요 영상 등록</h1>
          <form action="adminStudyInsertDoing.go"  method="post" enctype="multipart/form-data">
    <table style="width:100%; height:800" >
  <tbody>
    <tr height="50">
      <th width="10%" style="text-align:center">제목 </th>
      <td colspan="2" width="50%">
      <input type="text" class="form-control" name="v_title" placeholder="제목을 입력하세요">
      </td>
		<th width="10%" style="text-align:center">분류</th>
		<td width="30%">
			                 <select name="resertype" id="resertype">
                  <option value="adminVideoInsert.go" >춤을 춰요</option>
                  <option value="adminStudyInsert.go" selected>공부 해요</option>
                </select>
		</td>
    </tr>
    <tr height="50">
      ...
      <td width="30%">
        <input type='file' id="v_flashName" accept="video/*" name="v_videoName" />
      </td>
    </tr>
    <tr height="50">
...
<hr/>
<input type="submit" value="영상등록" class="btn btn-success btn-sm"/>
          </form>
      </div>
