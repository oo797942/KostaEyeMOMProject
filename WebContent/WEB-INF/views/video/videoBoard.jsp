...
<script type="text/javascript">
	...
	function fn_movePage(val){
	    ...
	    jQuery("form[name=frm]").attr("action","videoBoard.do").submit();
	}
</script>
</head>
<body>
													...
													<article class="Tarticle grid_4 alpha">
														<div class="indent-left">
															<figure class="frame2 p2">
																<img src="/EyeMOM/resources/img/${vo.d_photo}"
																	alt="" class='Timg' />
															</figure>
															<p class="Tp color-4 prev-indent-bot">
																${vo.d_title} </p>
															<p class='Tp1'>
																<label>추천수</label> <label>${vo.d_good}</label>
																&nbsp;&nbsp;&nbsp; <label>조회수</label><label>${vo.d_count}</label>&nbsp;&nbsp;&nbsp;
