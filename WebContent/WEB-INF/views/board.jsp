	...
	<div style="width: 65%" id="board1">
		<div class='form-inline'>
			<div class='boardinline'>
				<label class='boardlabel'>게시판종류 </label> <select id='select1' class="form-control">
					<option>게시판종류</option>
					<option>게시판종류</option>
					<option>게시판종류</option>
					<option>게시판종류</option>
			...
			<div id='kind1' class='boardinline'>
				<label class='boardlabel'>검색</label> <input type="text" name='search' id='search1'
					class='form-control'> <input type="button" name='searchbtn'
					id='searchbtn1' class='btn' value='검색'>
			</div>
		</div>
		<table class='boardtable'>
			<tr id="title1">				<!-- for문 입장 -->
