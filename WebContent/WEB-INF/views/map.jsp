<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% String obj = request.getParameter("keyword");
   String keyword = "";
   if( obj != null) keyword =  obj;
...
function dongName(latitude, longitude){
    ...
    var geocode = "http://maps.googleapis.com/maps/api/geocode/json?latlng="+latitude+","+longitude+"&sensor=false";
    $.ajax({
        url: geocode,
        type: 'POST',
...
//                alert(position.coords.latitude+"/"+position.coords.longitude);
               ...
               longitude=position.coords.longitude; /////사용자 위도 경도값 얻어오기
     dongName(latitude, longitude); //ajax호출
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="<%= keyword %>" name='keyword' id="keyword" size="15"> 
                    <button type="submit">검색하기</button> 
                </form>
                <label style="color:gray; margin-left: -30px;">ex) 삼평동 XXX</label>
            </div>
        </div>
        <hr>
        <ul id="placesList"></ul>
