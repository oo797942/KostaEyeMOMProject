...
<!--         메인 -->
 ...
 <form action="adminBoardInsertDoing.go" method="post" >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="3"><input type="text" name="b_title" id="b_title" class="form-control" placeholder="제목을 입력하세요."></td>
      </tr>
        <tr>
                  <td height="450" colspan="4">
                  <textarea class="form-control" name="b_content" id="articleContent" placeholder="내용을 입력하세요" style="width:100%; height:100%; resize:none"></textarea></td>
...
<hr/>
            <input type="submit" value="게시글 등록" class="btn btn-success btn-sm" id="articleInput" name="articleInput" />
