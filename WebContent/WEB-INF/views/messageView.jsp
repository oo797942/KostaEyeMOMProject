...
<!--             <span class="icon-bar"></span> -->
<!--           </button> -->
          <a class="navbar-brand" style="color:#fff">${vlists.s_nick}님의 메세지</a>
        </div>
      </div>
</nav>
					 ...
					 <table class="table" width="100%" height="190" border="0">
					    <tbody>
					      <tr border="1">
					        ...
					        <td align="center" width="40%">${vlist.s_title }</td>
					   
					      </tr>
					      <tr>
					        <th height="150" width="10%">내용 </th>
					        <td colspan="2" width="15%">
				<div  style="width:100%; height:100%;">${vlist.s_content }</div>
					        </td>
				          </tr>
