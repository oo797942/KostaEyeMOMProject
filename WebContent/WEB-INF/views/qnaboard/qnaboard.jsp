				...
				<div id='tableall2'>			 <!-- 게시판 전체 div -->
					...
					<table class='boardtable'>   <!-- 테이블 전체 div -->
						<tr id='trcolor2'>
							...
							<!-- 게시글 제목 -->
							<th colspan="9" class='boardtd1'><label id='title'>기모뤼</label></th>
							<!-- 게시판 카테고리 -->
							<th class='boardtd2'>
							<input type="hidden" id="cate" name="cate" value= "기모뤼">
						...
						<tr id='trcolor2'>
							...
							<!-- 게시자 -->
							<th colspan="9" class='boardtd1'><label id='id'>기모뤼</label></th>
							<!-- 게시일, 시간 -->
							<td class='boardtd2'><label id='date'>기모뤼</label></td>
						</tr>
						<!-- 조회수, 추천수, ip -->	
						<tr id='trcolor2'>
								<th class='countfont' width="20px">조회수&nbsp;&nbsp;:</th>
								<!-- 조회수 -->
								<th  class='countfont alignleft'id='count'>기모뤼</th>
								<th class='countfont'width="20px">추천수&nbsp;&nbsp;:</th>
								<!-- 추천수 -->
								<th class='countfont alignleft' id='good'>기모뤼</th>
								<th width="40px"></th>
								<th width="40px"></th>
								<th colspan="4"></th>
								<!-- 게시자 ip -->
								<td><p class='boardip' id='ip'>기모뤼</p></td>
						</tr>
						<tr id='trcolor2'>
							<!-- 내용뷰 -->
