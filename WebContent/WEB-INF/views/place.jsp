...
ㅁㅁㅁㅁㅁ
		...
		<tr >
			...
			<div style="text-align: center;" >
				<a href="place.do?keyword=키즈카페" class='tableB'><div class='MapDiv nodap'>키즈카페</div></a>
			...
			<div style="text-align: center;" >
				...
				<a href="place.do?keyword=문화센터" class='tableB'><div class='MapDiv nodap'>문화센터</div></a>
				<a href="place.do?keyword=놀이터" class='tableA'><div class='MapDiv nodap'>놀이터</div></a>
				<a href="place.do?keyword=병원" class='tableA'><div class='MapDiv nodap'>병원</div></a>
			</div>	
			</c:if>
			...
			<div style="text-align: center;" >
				<a href="place.do?keyword=키즈카페" class='tableA'><div class='MapDiv nodap'>키즈카페</div></a>
				<a href="place.do?keyword=문화센터" class='tableA'><div class='MapDiv nodap'>문화센터</div></a>
				<a href="place.do?keyword=놀이터" class='tableB'><div class='MapDiv nodap'>놀이터</div></a>
				<a href="place.do?keyword=병원" class='tableA'><div class='MapDiv nodap'>병원</div></a>
			</div>
			</c:if>
			...
			<div style="text-align: center;" >
				...
				<a href="place.do?keyword=문화센터" class='tableA'><div class='MapDiv nodap'>문화센터</div></a>
				<a href="place.do?keyword=놀이터" class='tableA'><div class='MapDiv nodap'>놀이터</div></a>
				<a href="place.do?keyword=병원" class='tableB'><div class='MapDiv nodap'>병원</div></a>
			</div>
			</c:if>
			</div>
			</td>
